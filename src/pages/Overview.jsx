  ...
  return (
    <div className="pt-24">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.92), rgba(255, 255, 255, 0.92)), url('https://images.unsplash.com/photo-1518391846015-55a9cc003b25?q=80&w=2070')`,
        }}
      >
